...
Define the isolated integration-test workflow for the live memory service stack, including disposable Docker-managed dependencies, internal-network test execution, and the boundary between functional verification and manual smoke checks.
