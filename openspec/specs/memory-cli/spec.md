...
Define the thin typed CLI for the stable v1 memory API so manual inspection and debugging can reuse the shared Python client without changing the service contract.
