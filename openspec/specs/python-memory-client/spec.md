...
Define the thin typed Python client for the stable v1 memory API so later adapters can reuse one shared HTTP boundary without changing the service contract.
